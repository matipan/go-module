...
//
//	go build -ldflags "
//	    -X github.com/dagger/go/buildinfo.InjectedVCS=git
//	    -X github.com/dagger/go/buildinfo.InjectedVCSRevision=$(git rev-parse HEAD)
//	    -X github.com/dagger/go/buildinfo.InjectedVCSModified=false
//	    -X github.com/dagger/go/buildinfo.InjectedVCSTime=$(git log -1 --format=%cI)
//	" ./...
//
